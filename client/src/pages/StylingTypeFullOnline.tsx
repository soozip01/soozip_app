...
const STEPS = [
  ...
  },
  {
    ...
    emoji: "📸",
    title: "현장 사진 및 도면 제출",
    desc: "현재 공간의 전체 사진과 도면을 업로드해주세요.",
  },
  {
    step: 3,
    emoji: "💬",
    title: "스타일리스트 1:1 온라인 상담",
    desc: "전담 스타일리스트와 화상 또는 채팅으로 상세 상담을 진행합니다.",
  },
  {
    step: 4,
    emoji: "🎨",
    title: "3D 스타일링 플랜 제안",
    desc: "가구 배치부터 소품, 컬러 팔레트까지 완성된 3D 플랜을 제안해드립니다.",
  },
  {
    step: 5,
    emoji: "🛒",
    title: "제품 큐레이션",
    desc: "제안된 스타일에 맞는 수집 입점 브랜드 제품을 추천해드립니다.",
  },
  {
    step: 6,
    emoji: "✅",
    title: "최종 확인 및 완료",
    desc: "플랜 검토 후 수정 요청 2회 가능합니다.",
  },
];
      ...
      <main className="flex-1 px-4 pt-6 pb-10 flex flex-col gap-5">
        ...
        <div className="bg-gray-100 rounded-2xl p-5 relative">
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <p className="font-bold text-gray-900 text-base">풀 스타일링 (온라인 전용)</p>
              <p className="text-gray-500 text-xs mt-0.5">완전한 공간 변신, 빠르게 온라인으로</p>
            </div>
          </div>
          <div className="border-t border-gray-200 pt-3 mt-1">
            ...
            <ul className="space-y-1.5">
              ...
              <li className="text-gray-700 text-[12px] flex items-start gap-1.5">
                <span className="text-green-500 shrink-0 mt-0.5">✓</span>
                <span>전국 어디서나 서비스를 받고 싶으신 분</span>
              </li>
            </ul>
          </div>
        </div>
