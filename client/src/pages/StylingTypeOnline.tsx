...
const IMGS = {
  // 소개 섹션
  hyuna: `${CDN}/hyuna_94688ed9.png`,
  ddanya: `${CDN}/ddanya_00197013.png`,
  // STEP 01
        ...
        <section className="px-4 pt-6 pb-6">
          <div className="grid grid-cols-2 gap-4 mb-5">
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-500 text-[11px] text-center mt-1.5">현아 님 거실 스타일링</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="w-full rounded-xl overflow-hidden bg-gray-100" style={{ aspectRatio: "3/4" }}>
                <img
              ...
              <p className="text-gray-500 text-[11px] text-center mt-1.5">따냐 님 침실 스타일링</p>
            </div>
          </div>
